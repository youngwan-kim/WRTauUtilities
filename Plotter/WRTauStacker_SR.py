...
l_regions_presels = ["BoostedSignalRegion","ResolvedSignalRegion"] #,"BoostedLowMassControlRegion","ResolvedLowMassControlRegion","BoostedSignalRegionMETInvertMTSame","ResolvedSignalRegionMETInvertMTSame"]
...
for region in l_regions :
    ...
    for (vJ,vEl,vMu) in IDcomb :
        ...
        VarDic[f"{region}/ProperMeffWR"][6] = [900,1200,1700,2500,5000,8000]
        for var in VarDic : 
            ...
            l.AddEntry(h_stackerr,"Stat #oplus Syst","f")
            if not hastobeBlinded : l.AddEntry(h_data,"Obs.+ Unc.","lep")
