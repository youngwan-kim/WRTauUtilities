...
with open("../data/xsec_tauOnly.csv") as xsec :
    for line in xsec :
...
xsec_hist.GetZaxis().SetTitle("#sigma(pp#rightarrowW_{R})#timesB(W_{R}#rightarrow#tau#tauqq) [pb]")
