...
l_regions = [f"{region}{suffix}" for region in l_regions_withMET for suffix in ["_ElTau", "_MuTau"]] # ,"_ElTau", "_MuTau"
...
for region in l_regions :
    ...
    for (vJ,vEl,vMu) in IDcomb :
        ...
        VarDic = {
            ...
            f"{region}/Jets/FatJet_0_Eta" : [True,5,"Leading AK8 Jet #eta","AK8J0_Eta",-3.,3.],
            ...
            f"{region}/Jets/Jet_0_Eta" : [True,5,"Leading AK4 Jet #eta","AK4j0_Eta",-3.,3.],
            ...
            f"{region}/HighPtTight/Lepton_0_Eta" : [True,5,f"Leading Tight {lep_ex} #eta","TightLep0_Eta",-3.,3.],
            ...
            f"{region}/HighPtLoose/Lepton_0_Eta" : [True,5,f"Leading Loose {lep_ex} #eta","LooseLep0_Eta",-3.,3.],
        ...
        if "Boosted" in region :
            ...
            if "LowMassCR" in region : VarDic[f"{region}/MTBoostedWR"] = [True,5,f"m_{{T}}(#tau_{{h}}{lep}J) [GeV]","MTthlJ",0.,800.,[0,50,100,150,200,250,300,400,600,800],True]
            else : VarDic[f"{region}/MTBoostedWR"] = [True,5,f"m_{{T}}(#tau_{{h}}{lep}J) [GeV]","MTthlJ",0.,1000.,[0,50,100,150,200,250,300,400,600,1000],True]
        ...
        if "Resolved" in region : 
            ...
            if "LowMassCR" in region : VarDic[f"{region}/MTResolvedWR"] = [True,50,f"m_{{T}}(#tau_{{h}}{lep}jj) [GeV]","MTthjj",0.,800.,[0,50,100,150,200,250,300,400,600,800],True]
            else : VarDic[f"{region}/MTResolvedWR"] = [True,50,f"m_{{T}}(#tau_{{h}}{lep}jj) [GeV]","MTthjj",0.,1000.,[0,50,100,150,200,250,300,400,600,1000],True]
