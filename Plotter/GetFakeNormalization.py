...
l_regions_prefix = ["BoostedSignalRegionMETInvertMTSame","ResolvedSignalRegionMETInvertMTSame",
...
for era in l_era :
    ...
    f_MCFake = TFile(f"../RootFiles/{stamp}/{era}/WRTau_Analyzer_PromptFakes.root")
    for region in l_regions :
        ...
        h_MCFake = f_MCFake.Get(f"Central/{region}/Nevents")
        n_MCFake = h_MCFake.Integral()
        ...
        ratio = (n_data - n_MC )/(n_fake  - n_MCFake) 
