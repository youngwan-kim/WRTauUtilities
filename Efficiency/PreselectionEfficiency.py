...
with open('eff_signal.txt') as f :
    ...
    for mWR in d :
        ...
        graph_eff1e.SetTitle("Boosted Presel.")
        graph_eff2e.SetTitle("Resolved Presel.")
        graph_effelinc.SetTitle('Total')

        l1.AddEntry(graph_eff1e,"Boosted Presel.")
        l1.AddEntry(graph_eff2e,"Resolved Presel.")
        ...
        graph_eff1mu.SetTitle("Boosted Presel.")
        graph_eff2mu.SetTitle("Resolved Presel.")
        ...
        l2.AddEntry(graph_eff1mu,"Boosted Presel.")
        l2.AddEntry(graph_eff2mu,"Resolved Presel.")
        ...
        c2.SaveAs(f"{savedir}/mWR{mWR}_MuTau_PreselEff.pdf")
