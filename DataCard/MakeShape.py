...
for r in d_region :
    ...
    for era in l_era : 
        ...
        l_syst_xsec = ["ScaleUp","ScaleDown","PDFUp","PDFDown"]
        ...
        for syst in l_syst :
                ...
                for j,channel in enumerate(["ElTau","MuTau"]) :  
                    ...
                    if check(f_top, f"{syst}/__PromptTau__PromptLepton/{region}_{channel}/ProperMeffWR") :
                        ...
                        if check(f_top, f"{syst}/__PromptTau__NonPromptLepton/{region}_{channel}/ProperMeffWR") : 
                            h_fakeMC_top_tmp   = f_top.Get(f"{syst}/__PromptTau__NonPromptLepton/{region}_{channel}/ProperMeffWR")
                            h_fakeMC_top_tmp.SetDirectory(0)
                            h_top_tmp.Add(h_fakeMC_top_tmp)
                    ...
                    if check(f_boson, f"{syst}/__PromptTau__PromptLepton/{region}_{channel}/ProperMeffWR") :
                        ...
                        if check(f_boson, f"{syst}/__PromptTau__NonPromptLepton/{region}_{channel}/ProperMeffWR") : 
                            h_fakeMC_boson_tmp   = f_boson.Get(f"{syst}/__PromptTau__NonPromptLepton/{region}_{channel}/ProperMeffWR")
                            h_fakeMC_boson_tmp.SetDirectory(0)
                            h_boson_tmp.Add(h_fakeMC_boson_tmp)
            ...
            d_top[syst], d_boson[syst]  = h_top, h_boson
            ...
            d_top_save[syst], d_boson_save[syst] = h_top_save, h_boson_save
        ...
        h_data_tmp = d_top_save["Central"] + d_boson_save["Central"] + d_fake_save["Central"]
        ...
        for mwr in d_mass_ :
            for mn in d_mass_[mwr] :
                ...
                for syst in l_syst : 
                    ...
                    for item in [d_top_save[syst],d_boson_save[syst],h_signal_save] :
