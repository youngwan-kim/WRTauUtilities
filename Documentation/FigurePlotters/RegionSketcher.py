...
label_x = ROOT.TLatex(0.75, 0.025, "M_{T}^{W_{R}} [GeV]")
label_x.SetTextSize(0.05)
label_x.SetTextFont(42)
label_x.Draw()

label_y = ROOT.TLatex(0.05, 0.775, "#slash{E}_{T} [GeV]")
label_y.SetTextAngle(90)
label_y.SetTextSize(0.05)
label_y.SetTextFont(42)
label_y.Draw()

cut_y = ROOT.TLatex(0.02, 0.585, "100")
...
rectangle.Draw()
label_FM = ROOT.TLatex(0.63, 0.375, "Tau Fake")
label_FM.SetTextSize(0.05)
label_FM.SetTextFont(61)
label_FM.SetTextColor(ROOT.kBlue+2)
label_FM.Draw()
label_FM2 = ROOT.TLatex(0.5, 0.325, "Measurement Region")
